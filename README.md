...
Repository lưu các bài tập lập trình vi điều khiển trên **ESP32-S3** và nội dung nghiên cứu kiến trúc máy tính. Các bài thực hành tập trung vào điều khiển ngoại vi ở mức thanh ghi thay vì sử dụng API GPIO cấp cao của ESP-IDF.
...
Chi tiết đấu nối và hoạt động của từng chương trình nằm trong README của từng bài thực hành. Báo cáo nghiên cứu được lưu trực tiếp dưới dạng Markdown trong thư mục tương ứng.
